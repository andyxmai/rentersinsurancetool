  ...
  return (
    <div className='section'>
      <div className='section-container'>
        ...
        <div>
          Renters insurance provides coverage for your personal properties and as well any liabilities stemmed from bodily injury and property damage caused by your actions or negligence.
        </div>
      </div>
      <br />
      <div className='section-container'>
